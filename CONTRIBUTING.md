...
4. [Adding a New Encryption Algorithm](#adding-a-new-encryption-algorithm)
5. [Coding Standards](#coding-standards)
6. [Reporting Bugs & Security Vulnerabilities](#reporting-bugs--security-vulnerabilities)
